...
The v0.2.0 supported baseline is NGINX 1.30.4 on Ubuntu 24.04/Linux x86_64 and ARM64.
...
NGINX HTTP/3 is experimental upstream. The v0.2.0 contract covers ordinary
